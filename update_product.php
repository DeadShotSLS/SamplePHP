...
$error = '<div class="alert alert-danger alert-dismissible fade show">
    ...
    {          
$sql = "update products set product_title='$_POST[p_name]',product_price='$_POST[price]',product_desc='$_POST[p_desc]',product_image='$fnew' where product_id='$_GET[product_upd]'";  // update the submited data ino the database :images
mysqli_query($db, $sql); 
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="p_name" class="form-control" value="<?php echo $roww['product_title'];?>" placeholder="Enter Product Name">
                                                   </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="price" class="form-control" value="<?php echo $roww['product_price'];?>" placeholder="Rs">
                                                   </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
